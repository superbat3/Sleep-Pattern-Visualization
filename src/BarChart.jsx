...
export default function BarChart({ data }) {
  ...
  // ---- Compute average sleep duration by occupation ----
  const grouped = useMemo(() => {
    if (!Array.isArray(data)) return [];

    const groups = d3.group(data, (d) => d.occupation);
